...
namespace EasyService.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {               
                case SignInStatus.Success:
                    ...
                    else if(UserManager.IsInRole(userId,"Vendor"))
                    {
        ...
        public ActionResult Register()
        {
            ...
            ViewBag.roleList = applicationDbContext.Roles.OrderBy(r => r.Name).ToList().Select(rr => new SelectListItem { Value = rr.Name.ToString(), Text = rr.Name }).ToList();
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model,string RoleName)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["ResultMessage"] = "Registration successfully !";
